/**
 * axios配置：可自行根据项目进行更改，只需更改该文件即可，本文件内其他文件勿动
 * 参考：https://doc.vvbin.cn/guide/mock.html#index-ts-%E9%85%8D%E7%BD%AE%E8%AF%B4%E6%98%8E
 */
...
import { joinTimestamp, formatRequestDate, handleErrorFunction } from './helper'
